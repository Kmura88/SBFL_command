...
rem .execの生成
java -javaagent:jacoco/jacocoagent.jar=destfile=../%TMP_FOLDER%/jacoco.exec,append=false -cp "junit/junit-4.13.2.jar;junit/hamcrest-core-1.3.jar;../classes" RunSingleTestForJUnit3 %CLASS_NAME% %METHOD_NAME%
